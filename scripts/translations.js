const translations = {
  ...
  fr: {
    ...
    welcomeText: "Cet outil est conçu pour aider la communauté PokéRogue à évaluer les différents Pokémon disponibles.",
    ...
    criteriaDescriptions: {
      ...
      cost: "Rapport qualité/prix du Pokémon.",
      eggMoves: "Impact des capacités œufs sur l'efficacité globale du Pokémon.",
      passive: "Impact et importance du passif du Pokémon sur son efficacité.",
      outOfTheBox: "Viabilité du Pokémon sans nécessiter de CT, objets ou évolution.",
    },
  },
  de: {
    siteTitle: "Rate My Starter",
